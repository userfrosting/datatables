...
/* UFDatatable Plugin : updated the path to include ccs/ */            
    
    $app->schema->registerCSS("common", "css/font-awesome-4.3.0.css");
    $app->schema->registerCSS("common", "css/font-starcraft.css");
    $app->schema->registerCSS("common", "css/bootstrap-3.3.2.css");
    $app->schema->registerCSS("common", "css/bootstrap-modal-bs3patch.css");   // Must be included BEFORE bootstrap-modal.css
    $app->schema->registerCSS("common", "css/bootstrap-modal.css");
    $app->schema->registerCSS("common", "css/lib/metisMenu.css");
    $app->schema->registerCSS("common", "css/bootstrap-custom.css");
    $app->schema->registerCSS("common", "css/bootstrap-switch.css");
    $app->schema->registerCSS("common", "css/tablesorter/theme.bootstrap.css");
    $app->schema->registerCSS("common", "css/tablesorter/jquery.tablesorter.pager.css");
    $app->schema->registerCSS("common", "css/select2/select2.css");
    $app->schema->registerCSS("common", "css/select2/select2-bootstrap.css");
    $app->schema->registerCSS("common", "css/bootstrapradio.css");

    // Dashboard CSS
/* UFDatatable Plugin : updated the path to include ccs/ */            
    $app->schema->registerCSS("dashboard", "css/timeline.css");
    $app->schema->registerCSS("dashboard", "css/lib/morris.css");
    $app->schema->registerCSS("dashboard", "http://code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css");

    // Logged-out CSS
/* UFDatatable Plugin : updated the path to include ccs/ */            
    $app->schema->registerCSS("loggedout", "css/jumbotron-narrow.css");

}, 1);

$app->hook('includes.js.register', function () use ($app){
    // Register common JS files
/* UFDatatable Plugin : updated the path to include js/ */            
    $app->schema->registerJS("common", "js/jquery-1.11.2.js");
    $app->schema->registerJS("common", "js/bootstrap-3.3.2.js");
    $app->schema->registerJS("common", "js/bootstrap-modal.js");
    $app->schema->registerJS("common", "js/bootstrap-modalmanager.js");
    $app->schema->registerJS("common", "js/sb-admin-2.js");
    $app->schema->registerJS("common", "js/lib/metisMenu.js");
    $app->schema->registerJS("common", "js/jqueryValidation/jquery.validate.js");
    $app->schema->registerJS("common", "js/jqueryValidation/additional-methods.js");
    $app->schema->registerJS("common", "js/jqueryValidation/jqueryvalidation-methods-fortress.js");
    $app->schema->registerJS("common", "js/moment.js");
    $app->schema->registerJS("common", "js/tablesorter/jquery.tablesorter.js");
    $app->schema->registerJS("common", "js/tablesorter/tables.js");
    $app->schema->registerJS("common", "js/tablesorter/jquery.tablesorter.pager.js");
    $app->schema->registerJS("common", "js/tablesorter/jquery.tablesorter.widgets.js");
    $app->schema->registerJS("common", "js/tablesorter/widgets/widget-sort2Hash.js");
    $app->schema->registerJS("common", "js/select2/select2.min.js");
    $app->schema->registerJS("common", "js/bootstrapradio.js");
    $app->schema->registerJS("common", "js/bootstrap-switch.js");
    $app->schema->registerJS("common", "js/handlebars-v1.2.0.js");
    $app->schema->registerJS("common", "js/userfrosting.js");

    // Dashboard JS
/* UFDatatable Plugin : updated the path to include js/ */            
    $app->schema->registerJS("dashboard", "js/lib/raphael.js");
    $app->schema->registerJS("dashboard", "js/lib/morris.js");

    // Users JS
/* UFDatatable Plugin : updated the path to include js/ */            
    $app->schema->registerJS("user", "js/widget-users.js");

    // Groups JS
/* UFDatatable Plugin : updated the path to include js/ */            
    $app->schema->registerJS("group", "js/widget-groups.js");

    // Auth JS
/* UFDatatable Plugin : updated the path to include js/ */            
    $app->schema->registerJS("auth", "js/widget-auth.js");
}, 1);
